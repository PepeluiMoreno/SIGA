...
REPARTO = {
    "TESORERO":       ["ECO_CUENTAS_ANUALES_GENERAR", "ECO_CUENTAS_ANUALES_DEPOSITAR", "ECO_CUENTAS_ANUALES_LISTAR"],
    "PRESIDENTE":     ["ECO_CUENTAS_ANUALES_APROBAR", "ECO_CUENTAS_ANUALES_LISTAR"],
    "VICEPRESIDENTE": ["ECO_CUENTAS_ANUALES_APROBAR", "ECO_CUENTAS_ANUALES_LISTAR"],
    "SECRETARIO":     ["ECO_CUENTAS_ANUALES_DEPOSITAR", "ECO_CUENTAS_ANUALES_LISTAR"],
}

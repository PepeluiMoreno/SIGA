...
Reparto:
- TESORERO: todas (JUST_PRESENTAR, JUST_ACEPTAR, JUST_APROBAR, JUST_PAGAR, JUST_LIST).
...
REPARTO = {
    "TESORERO": ["JUST_PRESENTAR", "JUST_ACEPTAR", "JUST_APROBAR", "JUST_PAGAR", "JUST_LIST"],
    "COORDINADOR":   ["JUST_PRESENTAR", "JUST_ACEPTAR", "JUST_LIST"],
    "COORD_PROV":    ["JUST_PRESENTAR", "JUST_ACEPTAR", "JUST_LIST"],
    "COORD_LOCAL":   ["JUST_PRESENTAR", "JUST_ACEPTAR", "JUST_LIST"],
    "PRESIDENTE":    ["JUST_PRESENTAR", "JUST_ACEPTAR", "JUST_LIST"],
    "VICEPRESIDENTE":["JUST_PRESENTAR", "JUST_ACEPTAR", "JUST_LIST"],
    "SECRETARIO":    ["JUST_PRESENTAR", "JUST_ACEPTAR", "JUST_LIST"],
}

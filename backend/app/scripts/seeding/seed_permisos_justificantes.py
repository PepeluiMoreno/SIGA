...
REPARTO = {
    ...
    "COORD_PROV":    ["ECO_JUSTIFICANTE_PRESENTAR", "ECO_JUSTIFICANTE_ACEPTAR", "ECO_JUSTIFICANTE_LISTAR"],
    "COORD_LOCAL":   ["ECO_JUSTIFICANTE_PRESENTAR", "ECO_JUSTIFICANTE_ACEPTAR", "ECO_JUSTIFICANTE_LISTAR"],

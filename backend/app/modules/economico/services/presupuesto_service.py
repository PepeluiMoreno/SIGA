...
class PresupuestoService:
    ...
    # ── Aviso de desviación presupuestaria (Fase 2 — ACTIVO) ──────────────────
    #
    # Control BLANDO: nunca bloquea; notifica a quien puede aprobar presupuesto
    # (permiso ECO_PRESUPUESTO_APROBAR) para que valore una modificación. Usa el
    # subsistema de comunicación: in-app siempre; email según la prioridad del
    # tipo 'PRESUPUESTO_DESVIACION' (NORMAL → solo in-app). La resolución por
    # permiso cubre los dos caminos RBAC (rol directo y vía funcionalidad).
    ...
    async def avisar_desviacion(self, partida: PartidaPresupuestaria) -> None:
        ...
        try:
            ...
            await NotificacionService(self.session).emitir(
            ...
            # Un fallo de aviso nunca afecta al registro del gasto.
            pass

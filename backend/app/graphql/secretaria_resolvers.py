...
from app.modules.secretaria.models.reunion import (
    TipoReunion, Reunion, AsistenteReunion, PuntoOrdenDia, Acuerdo, VotacionAcuerdo
)
...
from app.modules.secretaria.models.convenio import TipoConvenio, Convenio, DelegacionFirma
...
class ConvenioGQL:
    ...
    @staticmethod
    def from_model(m: Convenio) -> 'ConvenioGQL':
        return ConvenioGQL(

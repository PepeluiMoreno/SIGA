...
from .campania_resolvers import CampaniaEquipoQuery
...
@strawberry.type
class Query(AuthQuery, ConfiguracionOrganizacionQuery, EconomicoQuery, CategoriaFiscalQuery, CategorizacionQuery, PresupuestoQuery, SecretariaQuery, ComunicacionQuery, ChatQuery, MembresiaQuery, SociosQuery, VinculacionesQuery, CampaniaEquipoQuery):
    ...
    niveles_organos: list[NivelOrganoType] = campo(filter_input=NivelOrganoFilter)
    niveles_organos_cargos: list[NivelOrganoCargoType] = campo(filter_input=NivelOrganoCargoFilter)

...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_tipos_evento_activo'), 'tipos_evento', ['activo'], unique=False)
    op.create_index(op.f('ix_tipos_evento_eliminado'), 'tipos_evento', ['eliminado'], unique=False)
    ...
    op.create_index(op.f('ix_estados_evento_activo'), 'estados_evento', ['activo'], unique=False)
    op.create_index(op.f('ix_estados_evento_eliminado'), 'estados_evento', ['eliminado'], unique=False)
    ...
    op.create_index(op.f('ix_eventos_estado_id'), 'eventos', ['estado_id'], unique=False)
    op.create_index(op.f('ix_eventos_campania_id'), 'eventos', ['campania_id'], unique=False)
    op.create_index(op.f('ix_eventos_plantilla_id'), 'eventos', ['evento_plantilla_id'], unique=False)
    op.create_index(op.f('ix_eventos_eliminado'), 'eventos', ['eliminado'], unique=False)
    ...
    op.create_index(op.f('ix_participantes_evento_evento_id'), 'participantes_evento', ['evento_id'], unique=False)
    op.create_index(op.f('ix_participantes_evento_miembro_id'), 'participantes_evento', ['miembro_id'], unique=False)
    op.create_index(op.f('ix_participantes_evento_eliminado'), 'participantes_evento', ['eliminado'], unique=False)
    ...
    op.create_index(op.f('ix_materiales_evento_evento_id'), 'materiales_evento', ['evento_id'], unique=False)
    op.create_index(op.f('ix_materiales_evento_eliminado'), 'materiales_evento', ['eliminado'], unique=False)
    ...
    op.create_index(op.f('ix_grupos_evento_evento_id'), 'grupos_evento', ['evento_id'], unique=False)
    op.create_index(op.f('ix_grupos_evento_eliminado'), 'grupos_evento', ['eliminado'], unique=False)
    ...
    op.create_index(op.f('ix_tareas_evento_evento_id'), 'tareas_evento', ['evento_id'], unique=False)
    op.create_index(op.f('ix_tareas_evento_eliminado'), 'tareas_evento', ['eliminado'], unique=False)
    ...
    op.create_index(op.f('ix_gastos_evento_evento_id'), 'gastos_evento', ['evento_id'], unique=False)
    op.create_index(op.f('ix_gastos_evento_eliminado'), 'gastos_evento', ['eliminado'], unique=False)


def downgrade() -> None:
    op.drop_index(op.f('ix_gastos_evento_eliminado'), table_name='gastos_evento')
    op.drop_index(op.f('ix_gastos_evento_evento_id'), table_name='gastos_evento')
    op.drop_table('gastos_evento')

    op.drop_index(op.f('ix_tareas_evento_eliminado'), table_name='tareas_evento')
    op.drop_index(op.f('ix_tareas_evento_evento_id'), table_name='tareas_evento')
    op.drop_table('tareas_evento')

    op.drop_index(op.f('ix_grupos_evento_eliminado'), table_name='grupos_evento')
    op.drop_index(op.f('ix_grupos_evento_evento_id'), table_name='grupos_evento')
    op.drop_table('grupos_evento')

    op.drop_index(op.f('ix_materiales_evento_eliminado'), table_name='materiales_evento')
    op.drop_index(op.f('ix_materiales_evento_evento_id'), table_name='materiales_evento')
    op.drop_table('materiales_evento')

    op.drop_index(op.f('ix_participantes_evento_eliminado'), table_name='participantes_evento')
    op.drop_index(op.f('ix_participantes_evento_miembro_id'), table_name='participantes_evento')
    op.drop_index(op.f('ix_participantes_evento_evento_id'), table_name='participantes_evento')
    op.drop_table('participantes_evento')

    op.drop_constraint('fk_eventos_plantilla', 'eventos', type_='foreignkey')
    op.drop_index(op.f('ix_eventos_eliminado'), table_name='eventos')
    op.drop_index(op.f('ix_eventos_plantilla_id'), table_name='eventos')
    op.drop_index(op.f('ix_eventos_campania_id'), table_name='eventos')
    op.drop_index(op.f('ix_eventos_estado_id'), table_name='eventos')
    ...
    op.drop_index(op.f('ix_estados_evento_eliminado'), table_name='estados_evento')
    op.drop_index(op.f('ix_estados_evento_activo'), table_name='estados_evento')
    op.drop_table('estados_evento')

    op.drop_index(op.f('ix_tipos_evento_eliminado'), table_name='tipos_evento')
    op.drop_index(op.f('ix_tipos_evento_activo'), table_name='tipos_evento')

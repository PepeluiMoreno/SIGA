      ...
      <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Funcionalidades</th>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Transacciones</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="r in roles" :key="r.id" class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ r.funcionalidades?.length || 0 }}</td>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
              <div class="flex items-center justify-end gap-2">
                <router-link
                  ...
                  title="Editor de funcionalidades"
                >
